export default () => {
    const leftPane = document.getElementById("left-pane"),
      ...
      bottomPane = document.getElementById("bottom-pane"),
      verticalDivider = document.getElementById("vertical-divider"),
      horizontalDivider = document.getElementById("horizontal-divider"),
      leftThreshold = 30,
      rightThreshold = 70;

    verticalDivider.sdrag(
        function(el, pageX, startX, pageY, startY, resize) {
            resize.skipX = true;
